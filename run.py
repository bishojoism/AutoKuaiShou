            ...
            try:
                ...
                if result == "y":
                    ...
                    while True:
                        ...
                        try:
                            result = agent.run(
                                "翻评论区找到第一个发“我要这个——男朋友”的绿色表情包（而不是“女朋友”的红色表情包）的人，点她的头像（头像在昵称的左侧）进入她的主页点关注（如果是已经关注过的人或者朋友也忽略，显示“相互关注”也说明已经关注过了）。若已到当日关注上限则仅输出“y”，没达到输出“n”，其他什么都不要输出，严格按照这个格式来。警告：滑动的距离尽量小一点，起点y轴与终点y轴的差距不要超过300。"
                            )
                            if result == "y":
